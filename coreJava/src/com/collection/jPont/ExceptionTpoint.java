...
class MultpleExcetion{
	public static void multpleExcp() {
		...
		catch (Exception e) {System.out.println("Common Task is completedd...");}
	...
	public static void nextedExce() {
		try {
			try {
				...
				int b =30/0;
			} catch (ArithmeticException e) { System.out.println("inner eXceptin >> "+e);}
			try {
				int arr[] = new int[5];
				arr[5] = 4;
			}catch (ArrayIndexOutOfBoundsException e) { System.out.println("ArrayIndexOut Inner >> "+e);} 
...
class FinallyBlockTest{
	public static void finallyBlock() {
		try {
			int data =25/5;System.out.println("data >> "+data);
...
class FinallyException{
	public static void finallyExcOcc() {
		try {
			int data = 25/0; System.out.println("data2 >> "+data);
		} catch (NullPointerException e) { System.out.println(e);}
		finally {System.out.println("Finally Block is always executed case 2..");}
...
class FinallyExcept{
	public static void finalllyExcOc() {
		try {
			int b =25/0; System.out.println("b data >> "+b);
		} catch (ArithmeticException e) { System.out.println(e);}
		finally { System.out.println("Finally Block is always executed.. FinallyException2......");}
...
class PropgateExcepton{
	...
	static void p() {
		try {
			n();
		} catch (Exception e) { System.out.println("Exception handeld....");}
	}
}
class PropgateThrowException{
	 ...
	 static void p() {
		 try {
			n();
		} catch (Exception e) { System.out.println("Catch Exception Handled....");		}
	 }
}