...
// Java code to explain how to generate random password Here we are using random() method of util
import java.util.*;
...
{	public static void main(String[] args)
	...
	{	System.out.println("Generating password using random() : ");
		...
		// A strong password has Cap_chars, Lower_chars,// numeric value and symbols. So we are using all of
