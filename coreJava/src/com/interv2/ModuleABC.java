...
Given three digits as input, create a 4 digit number out of each input in which all 
the digits are the same. Then add all the 3 numbers and return the value.
*/
 ...
 * 3:- AndBooleans 
 * 
 * Given three booleans as input, return the and of the all
 * three booleans
 */
class AndBooleans {
	public static void main(String[] args) {
 ...
 * 6:- LargerThanOne 
 * 
 * Given three numbers as input, num, num1 and num2, return
 ...
 * 8:- MakeDecimal 
 * 
 * Given 3 digits a,b and c as input, return a double of the
 * form a.bc
 * 
 */
class MakeDecimal {
 ...
 * 10:- RequiredRunRate 
 * 
 * A team is chasing the target set in a one day
 ...
 */
class PerfectNumber {
	private static Scanner inpput;

	public static void main(String[] args) {
		PerfectNumber obj = new PerfectNumber();
		inpput = new Scanner(System.in);
		System.out.print("Enter a number is = ");
